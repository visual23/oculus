    ...
    while( the_repeater_field( 'content_block') ){        
        ...
        if($box_count == 0)
        {
            ...
            if(get_sub_field( 'mp4_video'))
            {
                ...
                echo '<div class="col-md-6 col-sm-6 nopadding colorBox" style="background-color: '.$bg_color_array[$bg_color_count].';"><div class="colorBoxText colorBoxColor text-center">'.get_sub_field('color_block').'</div></div>';
        ...
        else
        {
            ...
            {
                echo '<div class="row colorBoxes">';
                echo '<div class="col-md-6 col-sm-6 col-sm-push-6 nopadding colorBox" style="background-color: '.$bg_color_array[$bg_color_count].';"><div class="colorBoxText colorBoxColor text-center">'.get_sub_field('color_block').'</div></div>';
                echo '</div>';
                 echo '<div class="col-md-6 col-sm-6 col-sm-pull-6 nopadding colorBox">';
                echo '<div class="colorBoxVideo">';
                echo '<video id="example_video_'.$row_count.'" class="video-js vjs-default-skin" controls preload="auto" width="auto" height="auto" poster="'.get_sub_field( 'video_poster_image').'" data-setup=\'{"example_option":true}\'>';
                echo '<source src="'.get_sub_field( 'mp4_video').'" type="video/mp4" />';
                echo '<source src="'.get_sub_field( 'webm_video').'" type="video/webm" />';
